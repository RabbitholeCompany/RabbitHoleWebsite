import { _ as __astro_tag_component__, F as Fragment, h as createVNode } from './astro.836cabea.mjs';
import { f as $$Logo } from './pages/companyintro.astro.9d43c3c1.mjs';
import 'cookie';
import 'kleur/colors';
...
import 'string-width';
import 'html-escaper';
import './pages/404.astro.ce65b8c2.mjs';
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      style: "background:#333;padding: 10px 5px",
...
const file = "/Users/codeztree/Github/RabbitHoleWebsite/src/content/post/markdown-elements-demo-post.mdx";
const Content = (props = {}) => MDXContent({
											...props,
											components: { Fragment, ...props.components },
										});
Content[Symbol.for('astro.needsHeadRendering')] = !Boolean(frontmatter.layout);
Content.moduleId = "/Users/codeztree/Github/RabbitHoleWebsite/src/content/post/markdown-elements-demo-post.mdx";
